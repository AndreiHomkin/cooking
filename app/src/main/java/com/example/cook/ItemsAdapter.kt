...
class ItemsAdapter(private var items: List<Item>, private val isDarkMode: Boolean): RecyclerView.Adapter<ItemsAdapter.MyViewHolder>() {
    class MyViewHolder(view: View): RecyclerView.ViewHolder(view){
        ...
        val container: LinearLayout = view.findViewById(R.id.containerInList)
